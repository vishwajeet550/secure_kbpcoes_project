...
<body>
    <div class="main-data">
        ...
        <h3 class="list"> Image is Successfully Uploaded </h3><br>
        <!-- You can add your page heading -->
        
        <div class="list1">
            <br>
            <br>
            <h2 style="color: green;">&emsp; Thanks for showing an interest, Your image will be uploaded in our database within next 24hrs So, please kindly wait.</h2>
            <br>
            <br>
            <br>
            <br>
            <br>
            <h3><i> &emsp; For any query please contact your colege admin. </i></h3>
            <br>
        </div><br>
        <footer> <br> <img src="logo.jpg"><br>
            <p style="color: rgba(255, 255, 255, 0.822);">Last Update  7-Jun-21</p>
            <br>
